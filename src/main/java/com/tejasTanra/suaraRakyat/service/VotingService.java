...
public class VotingService {
    ...
    // ElectionEventRepository and CandidateRepository were deleted, so we remove the autowired.
    // @Autowired
    ...
    // public ElectionEvent createElectionEvent(UUID superAdminId, String name, LocalDateTime startTime, LocalDateTime endTime) {
    ...
    // public Candidate nominateCandidate(UUID pejabatId, UUID electionEventId, String vision, String mission) {
    ...
    // public Candidate verifyCandidate(UUID staffAdminId, UUID candidateId, CandidateStatus newStatus) {
    ...
    // public void castVote(UUID userId, UUID electionEventId, UUID candidateId) {
    ...
    // public List<Candidate> getElectionResults(UUID electionEventId) {
    //     Optional<ElectionEvent> optionalEvent = electionEventRepository.findById(electionEventId);
    //     if (optionalEvent.isEmpty()) {
    //         throw new IllegalArgumentException("Election event not found.");
    //     }
    ...
    // public Optional<ElectionEvent> findElectionEventById(UUID id) {
    ...
    // public List<Candidate> findCandidatesByElectionEvent(UUID electionEventId) {
    //     return candidateRepository.findByElectionEventId(electionEventId);
    // }
}
